...
```python
from nazev_balicku.modul_path import fn_1  # konkrétní funkce
from nazev_balicku.modul_path import *  # všechny funkce (nedoporučeno)
...
- proměnná `__all__` v modulu definuje, co se exportuje při `import *`
- uvnitř balíčku lze používat relativní importy (`from .modul import fn`)
- příklad `__init__.py`

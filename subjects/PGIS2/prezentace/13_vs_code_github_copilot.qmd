...
- nestaví striktně na jednom modelu – lze vybrat dle potřeby
- podporuje modely od **OpenAI** (ChatGPT), **Anthropic** (Claude) a **Google** (Gemini)
...
- **chat** – dotazy na kód s kontextem (`#file`, `#selection`, `#codebase`)
- **Agent mode** – Copilot sám navrhuje a provádí změny v celém projektu
...
"github.copilot.chat.codeGeneration.instructions": [
    {
        "text": "Komentáře v kódu piš vždy česky."
    },
    {
        // odkaz na soubor s instrukcemi

...
- pro naše použití preferovaná varianta


## Popisy objektů

- `arcpy.da.Describe()` - popis objektu dle zadaného názvu, lze i specifikovat typ objektu (pro případ shody názvů)
- výsledný obsah se liší dle požadovaného typu objektu - viz [dokumentace](https://pro.arcgis.com/en/pro-app/latest/arcpy/functions/describe.htm)
...
- je vhodné naučit se přistupovat k proměnným objektu pomocí konstrukce
...
- typicky `arcpy.List*()`
- slouží pro zjišťování, tam kde nemáme předem představu o obsahu
